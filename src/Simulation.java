...
//                    + r.currentWeight + "; Item added");
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println("Budget of U1 fleet for phase 1 = " + budgetU1phase1 + " (million)");

        int budgetU1phase2 = sim.runSimulation(u1FleetPhase2);
        System.out.println("Budget of U1 fleet for phase 2 = " + budgetU1phase2 + " (million)");
        ...
        System.out.println("Budget of U2 fleet for phase 1 = " + budgetU2phase1 + " (million)");

        int budgetU2phase2 = sim.runSimulation(u2FleetPhase2);
        System.out.println("Budget of U2 fleet for phase 2 = " + budgetU2phase2 + " (million)");
